 ...
 * generated in the com.example.javawsclient.service package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetAllProductsResponse_QNAME = new QName("http://service.javaspringws.example.com/", "getAllProductsResponse");
    private final static QName _AddProductResponse_QNAME = new QName("http://service.javaspringws.example.com/", "addProductResponse");
    private final static QName _SellProductResponse_QNAME = new QName("http://service.javaspringws.example.com/", "sellProductResponse");
    private final static QName _AddProduct_QNAME = new QName("http://service.javaspringws.example.com/", "addProduct");
    private final static QName _SellProduct_QNAME = new QName("http://service.javaspringws.example.com/", "sellProduct");
    private final static QName _GetAllProducts_QNAME = new QName("http://service.javaspringws.example.com/", "getAllProducts");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.example.javawsclient.service
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.javaspringws.example.com/", name = "getAllProductsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.javaspringws.example.com/", name = "addProductResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.javaspringws.example.com/", name = "sellProductResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.javaspringws.example.com/", name = "addProduct")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.javaspringws.example.com/", name = "sellProduct")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.javaspringws.example.com/", name = "getAllProducts")
