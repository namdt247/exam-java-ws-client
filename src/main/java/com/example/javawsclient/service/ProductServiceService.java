 ...
 * 
 */
@WebServiceClient(name = "ProductServiceService", targetNamespace = "http://service.javaspringws.example.com/", wsdlLocation = "http://localhost:8088/ws/products?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PRODUCTSERVICESERVICE_QNAME = new QName("http://service.javaspringws.example.com/", "ProductServiceService");
    ...
    public ProductService getProductServicePort() {
        return super.getPort(new QName("http://service.javaspringws.example.com/", "ProductServicePort"), ProductService.class);
    }
    ...
    public ProductService getProductServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.javaspringws.example.com/", "ProductServicePort"), ProductService.class, features);
    }
